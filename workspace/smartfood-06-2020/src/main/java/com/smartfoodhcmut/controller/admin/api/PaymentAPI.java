...
public class PaymentAPI extends HttpServlet {	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		if (session.getAttribute("order") != null) {
	        ...
	        String returnURL = "http://localhost:8080/trang-chu?page=1&maxPageItem=6&sortName=title&sortBy=asc&bill=1";
	        String notifyURL = "http://localhost:8080/trang-chu?page=1&maxPageItem=6&sortName=title&sortBy=asc&bill=1";
	     // String extraData = "";
	     // String bankCode = "SML";
