   ...
   <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
      ...
      <ul class="navbar-nav border-left flex-row ">
                  ...
                  <div class="notification__content">
                     ...
                     <p>
                        Last week your store’s sales count decreased by <span
                           class="text-danger text-semibold">5.52%</span>. It could have
                        been worse!
                     </p>
                  </div>
               </a>
         ...
         <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
               aria-expanded="false">
               <span class="d-none d-md-inline-block">
                  <h4 style="color: #e47676">${USERMODEL.fullName}</h4>
               </span>
            </a>
            <div class="dropdown-menu dropdown-menu-small">
               <a class="dropdown-item" href="#"> <i
                  ...
                  class="material-icons">vertical_split</i> Blog Posts
               </a> <a class="dropdown-item" href="#"> <i
                  class="material-icons">note_add</i> Add New Post
               </a>
               <div class="dropdown-divider"></div>
               <a class="dropdown-item text-danger" href='<c:url value="/thoat?action=logout"/>'> <i
